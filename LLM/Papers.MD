...
Through selective, symbolic interaction with the prompt, RLMs maintain strong performance on contexts that exceed the base model’s context window by orders of magnitude.
